...
const markers = [
    ...
    {
        id: 62,
        name: "ზუგდიდი რუხი, სოხუმის ქ92",
        position: { lat: 42.524338, lng: 41.867591 },
    },
    {
        id: 63,
        name: "წალენჯიხა კვარაცხელიას 7  (გეკო)",
        position: { lat: 42.613985, lng: 42.072882 },
    },
    {
        id: 64,
        name: "ჩხოროწყუ შენგელიას 8 (გეკო)",
        position: { lat: 42.519244, lng: 42.124843 },
    },
    {
        id: 65,
        name: "დაბა ჩხოროწყუ , ქუჩა კოსტავა , N 13",
        position: { lat: 42.518556, lng: 42.128613 },
    },
    {
        id: 66,
        name: "აბაშა, კ.გამსახურდია სოფ.კაპანა",
        position: { lat: 42.22013, lng: 42.21813 },
    },
    {
        id: 67,
        name: "ბორჯომი წაღვერიურეკი",
        position: { lat: 41.805341, lng: 43.475353},
    },
    {
        id: 68,
        name: "შინდისის გზატკეცილი 2-ე კმ",
        position: { lat: 41.99751, lng: 44.09316 },
    },
    {
        id: 69,
        name: "სოფელი ძეგვი",
        position: { lat: 41.843587, lng: 44.620109 },
    },
    {
        id: 70,
        name: "თელავი, თამარის ქუჩა",
        position: { lat: 41.914058, lng: 45.490679 },
    },
    {
        id: 71,
        name: "სოფელი ცოდნისკარი",
        position: { lat: 41.792513, lng: 46.169514 },
    },
    {
        id: 72,
        name: "თერჯოლა სოფ კვახჭირი",
        position: { lat: 42.19546, lng: 42.72505 },
    },
    {
        id: 73,
        name: "ახალქალაქი-კარწახი",
        position: { lat: 41.242090, lng: 43.270163 },
    },
    {
        id: 74,
        name: "ახალქალაქი-ნინოწმინდა",
        position: { lat: 41.273590, lng: 43.584562 },
    },
    {
        id: 75,
        name: "წერეთლის გამზ 155",
        position: { lat: 41.75240, lng: 44.77862 },
    },
    {
        id: 77,
        name: "მშვიდობის ქუჩა 12",
        position: { lat: 41.471923, lng: 44.814704 },
    },
    {
        id: 78,
        name: "ლეონიძის ქუჩა 19",
        position: { lat: 41.471923, lng: 44.814704},
    },
    {
        id: 79,
        name: "ალაზნის გამზირი",
        position: { lat: 41.925102, lng: 45.470834 },
    },
    {
        id: 80,
        name: "ახმეტა რუსთაველის ქ",
        position: { lat: 42.031886, lng: 45.209684 },
    },
    {
        id: 81,
        name: "ახმეტა სანაპირო",
        position: { lat: 42.031886, lng: 45.209684 },
    },
    {
        id: 82,
        name: "თბილისი, მუხიანი",
        position: { lat: 41.925102, lng: 45.470834 },
    },
    {
        id: 83,
        name: "თბილისი, მარშალ გელოვანი",
        position: { lat: 41.747154, lng: 44.770271 },
    },
    {
        id: 84,
        name: "ცენტრალური გზატკეცილი",
        position: { lat: 41.998598, lng: 43.654851 },
    },
    {
        id: 85,
        name: "საგარეჯო სოფ: წყაროსთავი",
        position: { lat: 41.73148, lng: 45.27704 },
    },
